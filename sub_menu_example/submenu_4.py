...
CONSOLE_TITLE = "sub 4"	# a text to define console window's title
...
SELECTION_MSG = False	# True/False: whether or not a msg prompt for up/down/enter keys is shown under the menu or not 
